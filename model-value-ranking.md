...
| 2 | [DeepSeek V4 Flash 0731](https://openrouter.ai/deepseek/deepseek-v4-flash-0731) | Open | 51.8 | $0.030 | **1,726.67** | AA configuration: Reasoning, Max Effort. Cheapest standard route is non-promotional FP4; validate endpoint accuracy for critical workloads. |
| 3 | [Solar Pro 4](https://openrouter.ai/upstage/solar-pro4) | API | 41.6 | $0.030 | **1,386.67** | Very low input price; API-only in the current catalog. |
...
| 14 | [Gemini 3.5 Flash Lite](https://openrouter.ai/google/gemini-3.5-flash-lite) | API | 37.4 | $0.300 | **124.67** | Older but still cost-competitive. |
| 15 | [Qwen3.7 Plus](https://openrouter.ai/qwen/qwen3.7-plus) | API | 39.4 | $0.320 | **123.13** | Hosted/API configuration. |
| 16 | [GLM-5.2](https://openrouter.ai/z-ai/glm-5.2) | Open | 52.6 | $0.490 | **107.35** | Strong value from the prior GLM generation. |
...
| 36 | [Claude Opus 5](https://openrouter.ai/anthropic/claude-opus-5) | API | 63.1 | $5.000 | **12.62** | Quality leader; poor fit for cost-control workloads. |
| 37 | [Claude Fable 5](https://openrouter.ai/anthropic/claude-fable-5) | API | 62.1 | $10.000 | **6.21** | High capability with the lowest ratio in the qualifying set. |
...
- Raw ratio leaders: Ling 3.0 Flash, DeepSeek V4 Flash 0731, and Solar Pro 4.
